...
<html>
    ...
    <body>
      ...
      <form class=" inputStudentName" action="/PTTK_HTTT/doTimTruyenThem.jsp" method="post">
        ...
        <table id="stuFound">
          ...
          <% if(listBookFound!=null)
              ...
              <tr>
                ...
                <td><a href="doChonTruyenThem.jsp?bookId=<%=listBookFound.get(i).getId()%>">Chọn</a></td>
              </tr>
              <% }%>
        </table>
      </form>
      ...
      <form class="stuFoundForm" action="doChonTruyen.jsp" method="post">
          ...
          <% if(listBookFound!=null)
              ...
              <tr>
                ...
                <td><a href="doXoaTruyenDangTimThem.jsp?bookId=<%=listBookChosen.get(i).getId()%>">Xóa</a></td>
              </tr>
              <% }%>
        </table>
        <a href="doXacNhanThueTruyenThem.jsp"><input type="button" name="goBack" value="Xác nhận thêm truyện"></a>
      </form>
